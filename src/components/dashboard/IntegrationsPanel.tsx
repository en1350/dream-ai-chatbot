            ...
            <div key={item.botId} className="rounded-2xl border border-white/8 bg-ink2/50 p-6">
              ...
              {item.connected ? (
                <div className="space-y-2">
                  ...
                  <div className="flex items-start gap-2 rounded-lg bg-amber-400/15 border border-amber-500/40 px-2.5 py-2">
                    ...
                    <p className="text-[11px] text-amber-900 leading-relaxed">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-amber-950 font-medium underline underline-offset-2 hover:text-amber-800"
                      >
                        управление сообществом
                      </a>{" "}
                      и проверьте две настройки:
                      <br />1) Сообщения → переключатель «Включены».
                      <br />2) Работа с API → Callback API → Типы событий → галочка «Входящее сообщение».
                    </p>
                  </div>
